            ...
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        <h2>Add User</h2>
                        <button className="btn close" onClick={props.onCloseClick}>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                {error.firstName && <p className="form-error">
                            ...
                            <div className="form-group">
                                ...
                                {error.lastName && <p className="form-error">
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    ...
                                    <input id="phoneNumber" name="phoneNumber" type="text" value={values.phoneNumber} onChange={changeHandler} onBlur={(e) => isPositive(e)} />
                                </div>
                        ...
                        <div className="form-group long-line">
                            ...
                            <div className="input-wrapper">
                                ...
                                <input id="imageUrl" name="imageUrl" type="text" value={values.imageUrl} onChange={changeHandler} onBlur={(e) => minLength(e, 20)} />
                            </div>
                            {error.imageUrl &&
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                {error.country && <p className="form-error">
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                {error.street && <p className="form-error">
                            ...
                            <div className="form-group">
                                ...
                                {error.streetNumber && <p className="form-error">
